...
from qiskit.quantum_info.operators.symplectic.pauli import Pauli  # added by auto_typehints
from typing import Iterable, List, Tuple  # added by auto_typehints
...
class SparsePauliOp(LinearOp):
    ...
    def equiv(self, other: "SparsePauliOp", atol: Optional[float] = None) -> bool:
