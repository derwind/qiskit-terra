...
from qiskit.circuit.gate import Gate  # added by auto_typehints
from qiskit.quantum_info.operators.operator import Operator  # added by auto_typehints
...
class OneQubitEulerDecomposer:
    ...
    def __call__(self, unitary: Operator | Gate | np.ndarray, simplify: bool = True, atol: float = 1e-12) -> QuantumCircuit:
    ...
    def _decompose(self, unitary, simplify = True, atol = 1e-12):
