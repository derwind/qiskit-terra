...
class TwoQubitWeylDecomposition:
    ...
    def circuit(self, *, euler_basis: Optional[str] = None, simplify = False, atol = 1e-12) -> QuantumCircuit:
...
class TwoQubitBasisDecomposer:
    ...
    def __init__(self, gate: Gate, basis_fidelity: float = 1.0, euler_basis: str = "U", pulse_optimize: Optional[bool] = None):
        self.gate = gate
    ...
    def __call__(self, unitary: Union[Operator, np.ndarray], basis_fidelity: Optional[float] = None, approximate: bool = True, *, _num_basis_uses: int | None = None) -> QuantumCircuit:
